...
<body>
    ...
    <header>
        ...
        <p id="montitre">The Powr Of Memory</p>
        <nav>
    ...
    <div class="image2">
        ...
        <img class="mid3" src="asset/poker.jpg" alt="">
    </div>
    ...
    <div class="all">
        ...
        <div class="lorem">
            <div class="boiteText">
                ...
                <div>
                    <h2>Lorem ipsum</h2>
                    <p>Quisque commodo facilisis purus, interdum volutpat arcu viverra sed.
                        Etiam sodales convallis pretium.
                        Aenean pharetra laoreet lorem. Nunc dapibus tincidunt sem a pharetra.
                        Duis vitae tristique leo, sed faucibus ipsum.</p>
                </div>
    ...
    <section class="ses2">
            <div class="bord">
                <img class="dogImg" src="asset/dog.png"/>
              ...
              <!-- <div class="btmbox"> -->
                ...
                <div class="pinkbox">
                    <div><h6>10 sec</h6></div>
                    <div><p>Temps Record</p></div>   
                </div>
    ...
    <section class="ses3">
    <div class="équipe">
        <p class="équipe1">Notre Équipe</p>
        <p class="équipe2">Quisque commodo facilisis purus, interdum volumtpat arcu viverra sed.</p>
    </div>

    <div class="fleurContainer">    
        <img class="fleur" src="asset/fleur.png" alt="">
    </div>  
    </section>
    ...
    <section class="ses4">
         ...
         <div class="sobox">
            <div class="name"><img src="asset/end2.png" class="end1">BEAUTIFUL<span class="text">very cool swag</span><div class="logoContainer"> 
                <a href="https://fr-fr.facebook.com/" target="_blank"><img class="f" src="asset/f.png" alt="tonimage" /></a>
                <a href="https://twitter.com/home?lang=fr" target="_blank"><img class="t" src="asset/t.png" alt="tonimage" /></a>
                <a href="https://www.pinterest.fr/" target="_blank"><img class="p" src="asset/p.png" alt="tonimage" /></a>
                </div>
            </div>
            <div class="name"><img src="asset/end2.png" class="end1">BEAUTIFUL<span class="text">very cool swag</span><div class="logoContainer"> 
                <a href="https://fr-fr.facebook.com/" target="_blank"><img class="f" src="asset/f.png" alt="tonimage" /></a>
